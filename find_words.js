...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'find_words.data';
      var REMOTE_PACKAGE_BASE = 'find_words.data';
...
var REMOTE_PACKAGE_SIZE = metadata['remote_package_size'];
    ...
    function runWithFS() {
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_find_words.data');

      };
      Module['addRunDependency']('datafile_find_words.data');
    ...
    loadPackage({"files": [{"filename": "/english_dict.txt", "start": 0, "end": 4234917}, {"filename": "/oxford_dict.txt", "start": 4234917, "end": 4576638}, {"filename": "/romanian_dict.txt", "start": 4576638, "end": 6708472}], "remote_package_size": 6708472});
...
var wasmBinaryFile;
  wasmBinaryFile = 'find_words.wasm';
